...
\begin{enumerate}
    ...
    \item Statistics
\end{enumerate}
The above systems are detailed in full in their respective subsections in Section 4: Sub-Systems of this report, but will we will briefly outline the functionality of each here and discuss their high-level interaction with one another.
...
\begin{figure}[H]
	\centering
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{FBLoginScreenshot.png}}
	\end{center}
...
\begin{figure}[H]
	\centering
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{AchievementsScreenshot.png}}
	\end{center}
...
\begin{figure}[H]
	\centering
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=0.5\paperwidth]{FriendsListScreenshot.png}}
	\end{center}
	\caption{User displaying the achievements page}
	\label{fig:my_label}
\end{figure}
